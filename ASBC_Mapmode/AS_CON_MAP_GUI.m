function AS_CON_MAP_GUI
D.fig = figure('Name','Across Subject connectivity(Seed to Whole Brain)',...       
    'units','normalized',...      
    'menubar','none',...       
    'numbertitle','off',...      
...
D.Comp = uicontrol('parent',D.fig,...
    'units','norm',...
    'pos',[0.1,0.05,0.3,0.08],...
    'style','pushbutton',...
    'string','Compute',...
    'Fontsize',10);
D.Exit = uicontrol('parent',D.fig,...
    'units','norm',...
    'pos',[0.6,0.05,0.3,0.08],...
    'style','pushbutton',...
    'string','Exit',...
    'Fontsize',10);
%
