function [DOUTSHOWaxial,DOUTSHOWcornoral,DOUTSHOWsagittal,DOUTSHOWaxialPOS,DOUTSHOWcornoralPOS,...
    DOUTSHOWsagittalPOS,DOUTSHOWaxialNEG,DOUTSHOWcornoralNEG,DOUTSHOWsagittalNEG,...
    dshownum]=AS_MapFCshow3sliceUP_GC_coef(outdir,inmixdir,inputdir_p,backgroundmap,pthrv,colmaxt,CLUSNUM)
...
try
    [vp dp] = Dynamic_read_dir_NIFTI(inputdir_p);
    dmid(dp<(1-pthrv)&dp>pthrv) = 0;
catch
    dp=zeros(size(dmid));
end
% if vbg.mat(1)<0
