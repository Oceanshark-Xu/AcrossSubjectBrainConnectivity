function [DOUTSHOWaxial,DOUTSHOWcornoral,DOUTSHOWsagittal,DOUTSHOWaxialPOS,...
    DOUTSHOWcornoralPOS,DOUTSHOWsagittalPOS,DOUTSHOWaxialNEG,DOUTSHOWcornoralNEG,...
    DOUTSHOWsagittalNEG,dshownum,ptempshow0001]=AS_MapFCshow3sliceU(outdir,inmixdir,backgroundmap,pthrv,labmarkinput,dof1,dof20,colmaxt,CLUSNUM)
...
if out<min(colmaxt)
    out = colmint;
    [ztempshow0001, ptempshow0001] = AS_TFRtoZ(out,labmark,dof,dof2);
else
    ptempshow0001 = pthr;
end
%
